...
public abstract class ActionBase {
     ...
     * @throws IOException
     */
    public abstract void process() throws ServletException, IOException; //こいつが重要な抽象メソッドで、フロントコントローラから呼び出される。サブクラスで実際の処理内容を定義している。
    ...
    protected void invoke()
        ...
        try {
            ...
            //getDeclaredMethodの第一引数がメソッド名、第二引数はそのメソッドに渡す引数。new Class[0]は引数なしの記述方法
