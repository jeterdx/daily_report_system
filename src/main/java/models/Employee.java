...
public class Employee {
     ...
     * 社員番号
     */
    @Column(name = JpaConst.EMP_COL_CODE, nullable = false, unique = true) //unique = true というのは一意制約という仕組みで、他と被りがないかを制御するもの。IDは単なる連番なので、このようにDB側でも制約を入れている。
    private String code;
